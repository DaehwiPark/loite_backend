package com.boot.loiteBackend.admin.policy.dto;
...
public class AdminPolicyDto {
    ...
    public static AdminPolicyDto fromEntity(AdminPolicyEntity entity) {
    ...
    public AdminPolicyEntity toEntity() {
        return AdminPolicyEntity.builder()
