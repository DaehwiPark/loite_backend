package com.boot.loiteBackend.support.faq.general.controller;
...
import com.boot.loiteBackend.support.faq.general.service.SupportFaqService;
...
public class SupportFaqController {
    ...
    public ResponseEntity<Page<SupportFaqDto>> getPagedFaqs(
        ...
        Page<SupportFaqDto> result = supportFaqService.getPagedFaqs(keyword, pageable);
