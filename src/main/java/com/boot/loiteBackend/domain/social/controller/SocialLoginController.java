package com.boot.loiteBackend.domain.social.controller;

import com.boot.loiteBackend.domain.social.dto.SocialUserRegistrationDto;
import com.boot.loiteBackend.domain.social.resolver.OAuthHandlerResolver;
import com.boot.loiteBackend.domain.social.service.SocialLoginService;
import com.boot.loiteBackend.domain.social.service.SocialRegisterService;
...
public class SocialLoginController {
    ...
    public ResponseEntity<ApiResponse<String>> getLoginUrl(@PathVariable String provider) {
        String url = handlerResolver.resolve(provider).getLoginUrl();
