...
public class SocialUserEntity {
    ...
    @Column(name = "SOCIAL_TYPE", nullable = false, length = 50,
            columnDefinition = "varchar(50) NOT NULL COMMENT '소셜 제공자 (예: GOOGLE, NAVER, KAKAO)'")
    private String socialType;

    @Column(name = "SOCIAL_NUMBER", nullable = false, length = 255,
            columnDefinition = "varchar(255) NOT NULL COMMENT '소셜 제공자 측 유저 고유 ID'")
    private String socialNumber;

    @Column(name = "SOCIAL_EMAIL", length = 100,
            columnDefinition = "varchar(100) DEFAULT NULL COMMENT '소셜 계정 이메일'")
    private String socialEmail;

    @Column(name = "SOCIAL_USER_NAME", length = 50,
            columnDefinition = "varchar(50) DEFAULT NULL COMMENT '소셜 계정 이름'")
    private String socialUserName;

    @Column(name = "CONNECTED_AT", nullable = false,
            columnDefinition = "timestamp NOT NULL DEFAULT current_timestamp() COMMENT '소셜 계정 연동 시각'")
