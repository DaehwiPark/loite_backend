package com.boot.loiteBackend.web.home.recommend.section.dto;
...
public class HomeRecoSectionResponseDto {
    ...
    public static HomeRecoSectionResponseDto fromEntity(HomeRecoSectionEntity e) {
        if (e == null) return null;
        return HomeRecoSectionResponseDto.builder()
                .id(e.getId())
                .title(e.getTitle())
